...
const originSrc = "./node_modules/pspdfkit/dist";
const staticResourcesDir = "./force-app/main/default/staticresources";
const pspdfkitJsDest = `${staticResourcesDir}/PSPDFKit.js`;
const pspdfkitLibDest = `${staticResourcesDir}/PSPDFKit_lib/pspdfkit-lib`;
const pspdfkitCoreDest = `${staticResourcesDir}/PSPDFKit_core/pspdfkit-lib`;
  ...
  pspdfkitLibDest,
  {
    filter(filepath) {
      ...
      if (filename.startsWith("chunk-locale-")) {
        ...
        filename.startsWith("chunk-1620-") &&
        path.extname(filepath) === ".js"
      ) {
        return true;
      } else if (
