(function () {
...
})()(
  {
      ...
      function (require, module, exports) {
        ...
        function _getTags(postParsed) {
          return postParsed.filter(isPlaceholder).reduce(function (tags, part) {
            ...
            if (part.subparsed) {
              tags[part.value] = merge(
                tags[part.value],
                _getTags(part.subparsed)
              );
            }
            return tags;
          }, {});
          ...
          _createClass(InspectModule, [
            ...
            },
            {
              ...
              value: function getAllTags() {
                var _this = this;
                return Object.keys(this.fullInspected).reduce(function (
                  result,
                  file
                ) {
    ...
    28: [
      ...
      { "./_Symbol": 10, "./_getRawTag": 62, "./_objectToString": 94 },
    ],
    29: [
      function (require, module, exports) {
      ...
      { "./_baseGetTag": 28, "./isObjectLike": 120 },
    ],
    30: [
      function (require, module, exports) {
    ...
    33: [
      ...
      { "./_baseGetTag": 28, "./isLength": 117, "./isObjectLike": 120 },
    ],
    34: [
      function (require, module, exports) {
      ...
      { "./_isPrototype": 79, "./_nativeKeys": 91 },
    ],
    35: [
      function (require, module, exports) {
        var isObject = require("./isObject"),
      ...
      { "./_isPrototype": 79, "./_nativeKeysIn": 92, "./isObject": 119 },
    ],
    36: [
      function (require, module, exports) {
        var Stack = require("./_Stack"),
    ...
    38: [
      ...
      { "./_overRest": 96, "./_setToString": 99, "./identity": 110 },
    ],
    39: [
      function (require, module, exports) {
      ...
      { "./_defineProperty": 55, "./constant": 108, "./identity": 110 },
    ],
    40: [
      function (require, module, exports) {
        /**
    ...
    49: [
      ...
      { "./_assignValue": 19, "./_baseAssignValue": 23 },
    ],
    50: [
      function (require, module, exports) {
        var copyObject = require("./_copyObject"),
    ...
    51: [
      ...
      { "./_copyObject": 49, "./_getSymbolsIn": 64 },
    ],
    52: [
      function (require, module, exports) {
        var root = require("./_root");
    ...
    53: [
      ...
      { "./_baseRest": 38, "./_isIterateeCall": 76 },
    ],
    54: [
      function (require, module, exports) {
        /**
    ...
    57: [
      ...
      { "./_baseGetAllKeys": 27, "./_getSymbols": 63, "./keys": 124 },
    ],
    58: [
      function (require, module, exports) {
        var baseGetAllKeys = require("./_baseGetAllKeys"),
      ...
      { "./_baseGetAllKeys": 27, "./_getSymbolsIn": 64, "./keysIn": 125 },
    ],
    59: [
      function (require, module, exports) {
    ...
    74: [
      ...
      { "./_baseCreate": 25, "./_getPrototype": 61, "./_isPrototype": 79 },
    ],
    75: [
      function (require, module, exports) {
    ...
    99: [
      ...
      { "./_baseSetToString": 39, "./_shortOut": 100 },
    ],
    100: [
      function (require, module, exports) {
    ...
    111: [
      ...
      { "./_baseIsArguments": 29, "./isObjectLike": 120 },
    ],
    112: [
      function (require, module, exports) {
        /**
    ...
    114: [
      ...
      { "./isArrayLike": 113, "./isObjectLike": 120 },
    ],
    115: [
      function (require, module, exports) {
        var root = require("./_root"),
    ...
    118: [
      ...
      { "./_baseIsMap": 30, "./_baseUnary": 41, "./_nodeUtil": 93 },
    ],
    119: [
      function (require, module, exports) {
        /**
    ...
    121: [
      ...
      { "./_baseGetTag": 28, "./_getPrototype": 61, "./isObjectLike": 120 },
    ],
    122: [
      function (require, module, exports) {
      ...
      { "./_baseIsSet": 32, "./_baseUnary": 41, "./_nodeUtil": 93 },
    ],
    123: [
      function (require, module, exports) {
      ...
      { "./_baseIsTypedArray": 33, "./_baseUnary": 41, "./_nodeUtil": 93 },
    ],
    124: [
      function (require, module, exports) {
      ...
      { "./_arrayLikeKeys": 16, "./_baseKeys": 34, "./isArrayLike": 113 },
    ],
    125: [
      function (require, module, exports) {
        var arrayLikeKeys = require("./_arrayLikeKeys"),
      ...
      { "./_arrayLikeKeys": 16, "./_baseKeysIn": 35, "./isArrayLike": 113 },
    ],
    126: [
      function (require, module, exports) {
        (function (global) {
    ...
    127: [
      ...
      { "./_baseMerge": 36, "./_createAssigner": 53 },
    ],
    128: [
      function (require, module, exports) {
        /**
    ...
    131: [
      function (require, module, exports) {
        ...
        console.log(cloneDeep({ c: 3 }));
        console.log("Inspect Module in code:");
        console.log(InspectModule);
        const iModule = InspectModule();
        console.log("iModule");
        console.log(iModule);
        window.iModule = iModule;
      },
      {
        "docxtemplater/js/inspect-module": 1,
        "lodash/cloneDeep": 107,
        "lodash/merge": 127,
      },
    ],
  },
