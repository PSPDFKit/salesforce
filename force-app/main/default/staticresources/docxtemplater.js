  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 380: /***/ function (
        ...
        _createClass(Docxtemplater, [
                ...
                throwApiVersionError(
                  "The major api version do not match, you probably have to update docxtemplater with npm install --save docxtemplater",
                  {
                    ...
                    explanation: "moduleAPIVersionMismatch : needed="
                      .concat(neededVersion.join("."), ", current=")
                      .concat(currentModuleApiVersion.join(".")),
                  }
                );
              }
          ...
          },
          {
            ...
            value: function attachModule(module) {
              ...
              if (!module || moduleType !== "object") {
                throw new XTInternalError(
                  "Cannot attachModule with a falsy value"
                );
              }
          ...
          },
          {
            ...
            value: function setOptions(options) {
              ...
              this.delimiters.start = DocUtils.utf8ToWord(
          ...
          },
          {
            ...
            value: function resolveData(data) {
              ...
              return Promise.resolve(data).then(function (data) {
                ...
                return Promise.all(
                  Object.keys(_this3.mapper).map(function (to) {
          ...
          },
          {
            ...
            value: function compile() {
              ...
              this.xmlDocuments = this.options.xmlFileNames.reduce(function (
                xmlDocuments,
                fileName
              ) {
          ...
          },
          {
            ...
            value: function getRelsTypes() {
              ...
              var rootRelationships = rootRelsXml
          ...
          },
          {
            ...
            value: function getContentTypes() {
              ...
              var contentTypeXml = contentTypes
                ? str2xml(contentTypes.asText())
                : null;
              var overrides = contentTypeXml
                ? contentTypeXml.getElementsByTagName("Override")
                : null;
              var defaults = contentTypeXml
          ...
          },
          {
            ...
            value: function updateFileTypeConfig() {
              ...
              if (contentTypeXml) {
                ...
                this.invertedContentTypes = DocUtils.invertMap(
                  this.filesContentTypes
                );
                this.setModules({
          ...
          },
          {
            ...
            value: function render(data) {
              ...
              Object.keys(this.mapper).forEach(function (to) {
                ...
                currentFile.scopeManager = _this7.getScopeManager(
                  to,
                  currentFile,
                  data
                );
          ...
          },
          {
            ...
            value: function getTemplatedFiles() {
              var _this10 = this;
              this.templatedFiles = this.fileTypeConfig.getTemplatedFiles(
                this.zip
              );
      ...
      function verifyErrors(doc) {
        ...
        doc.errors = concatArrays(
          Object.keys(compiled).map(function (name) {
    ...
    /***/ 257: /***/ function (
      ...
      function throwXmlTagNotFound(options) {
        var err = new XTTemplateError(
          'No tag "'
            .concat(options.element, '" was found at the ')
      ...
      function getCorruptCharactersException(_ref) {
        ...
        err.properties = {
          ...
          offset: offset,
          explanation:
            "There are some corrupt characters for the field ".concat(tag),
        };
        return err;
      }
      function getInvalidRawXMLValueException(_ref2) {
        ...
        err.properties = {
          ...
          value: value,
          offset: offset,
          explanation: "The value of the raw tag : '".concat(
            tag,
            "' is not a string"
          ),
        };
      ...
      function throwExpandNotFound(options) {
        var _options$part = options.part,
          ...
          id =
            _options$id === void 0 ? "raw_tag_outerxml_invalid" : _options$id,
          _options$message = options.message,
          message =
            _options$message === void 0
              ? "Raw tag not in paragraph"
              : _options$message;
        var part = options.part;
        var _options$explanation = options.explanation,
          explanation =
            _options$explanation === void 0
              ? 'The tag "'.concat(value, '" is not inside a paragraph')
              : _options$explanation;
      ...
      function getClosingTagNotMatchOpeningTag(_ref3) {
        ...
        err.properties = {
          ...
          explanation: 'The tag "'
            .concat(tags[0].value, '" is closed by the tag "')
            .concat(tags[1].value, '"'),
      ...
      function getScopeCompilationError(_ref4) {
        ...
        err.properties = {
          ...
          offset: offset,
          xtag: tag,
          explanation: 'The scope parser for the tag "'.concat(
            tag,
            '" failed to compile'
          ),
          rootError: rootError,
      ...
      function getLoopPositionProducesInvalidXMLError(_ref6) {
        var tag = _ref6.tag,
          offset = _ref6.offset;
        var err = new XTTemplateError(
          'The position of the loop tags "'.concat(
            tag,
      ...
      function throwXmlInvalid(content, offset) {
        ...
        err.properties = {
          ...
          offset: offset,
          explanation:
            "The docx contains invalid XML, it is most likely corrupt",
        };
        throw err;
      }
      function throwFileTypeNotHandled(fileType) {
        var err = new XTInternalError(
          'The filetype "'.concat(fileType, '" is not handled by docxtemplater')
        );
        err.properties = {
          id: "filetype_not_handled",
          explanation:
            'The file you are trying to generate is of type "'.concat(
              fileType,
    ...
    /***/ 330: /***/ function (module) {
      ...
      var pptxPresentationContentType =
        ...
        for (var i = 0, len = parts.length; i < len; i++) {
          ...
          for (var j = 0, len2 = contains.length; j < len2; j++) {
            ...
            if (currentlyCollecting === j) {
              ...
              collecting += part;
              for (
                var _k2 = 0, len3 = shouldContain.length;
                _k2 < len3;
                _k2++
              ) {
    ...
    /***/ 303: /***/ function (
      ...
      function getAllDelimiterIndexes(fullText, delimiters) {
        ...
        while (true) {
          ...
          if (
            ...
            var _insideTag = fullText.substr(
      ...
      module.exports = {
        ...
        parse: function parse(xmlparsed, delimiters) {
          ...
          var _parseDelimiters = parseDelimiters(
              ...
              for (var i = 0, len = keys.length; i < len; i++) {
                ...
                for (var _j = 0, _len = contentTypes.length; _j < _len; _j++) {
                  ...
                  if (invertedContentTypes[_ct]) {
                    for (
                      var k = 0, _len2 = invertedContentTypes[_ct].length;
                      k < _len2;
                      k++
                    ) {
    ...
    /***/ 999: /***/ function (
      ...
      var _require3 = __webpack_require__(257),
        ...
        getClosingTagNotMatchOpeningTag =
          _require3.getClosingTagNotMatchOpeningTag,
        ...
        _createClass(LoopModule, [
          ...
          },
          {
            ...
            value: function resolve(part, options) {
              ...
              function loopOver(scope, i, length) {
                var scopeManager = sm.createSubScopeManager(
                  scope,
                  part.value,
                  i,
                  part,
          ...
          },
          {
            ...
            value: function render(part, options) {
              ...
              function loopOver(scope, i, length) {
                heightOffset += tagHeight;
                var scopeManager = options.scopeManager.createSubScopeManager(
                  scope,
                  part.value,
                  i,
                  part,
                ...
                var subRendered = options.render(
                  _objectSpread(
                ...
                for (
                  var _i2 = 0, len = subRendered.parts.length;
                  _i2 < len;
                  _i2++
                ) {
              ...
              var result = options.scopeManager.loopOver(
                part.value,
                loopOver,
                part.inverted,
                {
              ...
              if (result === false) {
                if (part.lastParagrapSectPr) {
                  if (part.paragraphLoop) {
                    return {
                      value: "<w:p><w:pPr>".concat(
                        part.lastParagrapSectPr,
                        "</w:pPr></w:p>"
                      ),
                    };
                  }
    ...
    /***/ 182: /***/ function (
      ...
      var _require2 = __webpack_require__(257),
        throwRawTagShouldBeOnlyTextInParagraph =
          _require2.throwRawTagShouldBeOnlyTextInParagraph,
        getInvalidRawXMLValueException =
          _require2.getInvalidRawXMLValueException;
        ...
        _createClass(Render, [
          ...
          },
          {
            ...
            value: function recordRuns(part) {
              if (part.tag === "".concat(ftprefix[this.fileType], ":r")) {
                ...
                part.tag === "".concat(ftprefix[this.fileType], ":rPr")
              ) {
          ...
          },
          {
            ...
            value: function renderLineBreaks(value) {
              ...
              var br =
                this.fileType === "docx" ? "<w:r><w:br/></w:r>" : "<a:br/>";
          ...
          },
          {
            ...
            value: function postrender(parts) {
              ...
              for (var i = 0, len = parts.length; i < len; i++) {
                ...
                if (
                  endsWith(lastNonEmpty, wTpreserve) &&
                  startsWith(p, wtEnd)
                ) {
              ...
              if (token.position === "end") {
                options.parse = function (placeHolderContent) {
                  return moduleParse(
                    placeHolderContent,
                    _objectSpread(
                      _objectSpread(_objectSpread({}, options), token),
                      {},
                      {
                ...
                _objectSpread(
                  ...
                  {},
                  {
                    postparse: function postparse(parsed, opts) {
                      return _postparse(
                        parsed,
                        _objectSpread(_objectSpread({}, options), opts)
                      );
                    },
                    getTraits: getTraits,
                  }
    ...
    /***/ 919: /***/ function (
      ...
      function _getValue(tag, meta, num) {
        ...
        if (this.root.finishedResolving) {
          ...
          for (
            var i = this.resolveOffset, len = this.scopePath.length;
            i < len;
            i++
          ) {
            _loop();
        ...
        _createClass(ScopeManager, [
          {
            ...
            value: function loopOver(tag, functor, inverted, meta) {
              return this.loopOverValue(
                this.getValue(tag, meta),
                functor,
                inverted
              );
            },
          },
          {
            ...
            value: function functorIfInverted(
              inverted,
              functor,
              value,
              i,
            ...
            value: function getValueAsync(tag, meta) {
              ...
              return _getValueAsync
                ...
                .then(function (result) {
                  if (typeof result === "function") {
                    return result(
                      _this3.scopeList[_this3.scopeList.length - 1],
                      _this3
                    );
                  }
                  return result;
    ...
    /***/ 505: /***/ function (
      ...
      var _require2 = __webpack_require__(257),
        ...
        getLoopPositionProducesInvalidXMLError =
          _require2.getLoopPositionProducesInvalidXMLError;
      ...
      function expandToOne(postparsed, options) {
        ...
        limits.forEach(function (limit, i) {
          ...
          (_postparsed = postparsed).splice.apply(
            _postparsed,
            [result.left, result.right + 1 - result.left].concat(
              _toConsumableArray(result.inner)
            )
          );
        });
        return {
        ...
        _createClass(XmlTemplater, [
          ...
          },
          {
            ...
            value: function parse() {
              ...
              var _Parser$postparse = Parser.postparse(
                  this.parsed,
                  this.modules,
                  options
                ),
