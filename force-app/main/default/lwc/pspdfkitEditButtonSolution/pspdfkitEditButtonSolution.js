...
export default class PSPDFKitEditButtonSolution extends LightningElement {
    ...
    openFileInNewTab(){
        if(this.newTab == true){
            this.newWindow = window.open('/apex/PSPDFKit_InitPSPDFKit?id='+this.recordId,'_blank');
        }else{
            this.newWindow = window.open('/apex/PSPDFKit_InitPSPDFKit?id='+this.recordId,'_self');
        }
