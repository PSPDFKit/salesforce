...
import getbase64DataForSigning from "@salesforce/apex/PSPDFKitController.getbase64DataForSigning";
...
export default class PSPDFKitSignDocument extends LightningElement {
  ...
  wiredRecord({ error, data }) {
    ...
    const currentValue = getFieldValue(data, Name);
    console.log(currentValue);
    this.documentId = currentValue;

    const pendingDocumentId = getFieldValue(data, Id);
